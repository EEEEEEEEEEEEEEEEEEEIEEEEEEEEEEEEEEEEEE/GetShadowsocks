...
public class FreeActivity extends Activity {
	...
	public static final String URL_MAIN = "http://i.freevpnss.com/";
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 0) {
				...
				Toast.makeText(FreeActivity.this, "获取失败了呢(/TДT)/读取本地缓存", 0).show();
	...
	public void onclick_copy(View v) {//点击复制到剪切板
		...
		if (get) {
			...
			Toast.makeText(FreeActivity.this, "还没有获取内容呐_(:зゝ∠)_", 0).show();
		}
	}
